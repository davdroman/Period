...
struct ArithmeticTests {
	...
	@Test func `multiplication by positive scalar`() {
	...
	@Test func `multiplication by negative scalar`() {
		let period = Period(years: 1, months: 2)
		#expect(period * -1 == Period(years: -1, months: -2))
	}

	@Test func `multiplication is commutative`() {
		let period = Period(hours: 5, minutes: 30)
		#expect(period * 3 == 3 * period)
	}

	@Test func `multiplication compound assignment`() {
